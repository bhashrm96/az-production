...
export default function ClassifiedTableRow({ row, selected, onEditRow, onSelectRow, }) {
  ...
  const handleStatusChange = async (id) => {
    const res = await axios.put(`https://dev-azproduction-api.flynautstaging.com/admin/classified/update-status/${id}`, {
      headers: {
  ...
  return (
    <>
      ...
      <ClassifiedQuickEditForm currentClassified={row} open={quickEdit.value} onClose={quickEdit.onFalse} />
