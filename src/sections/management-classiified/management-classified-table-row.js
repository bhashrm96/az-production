...
import UserQuickEditForm from './management-classified-quick-edit-form';

// ----------------------------------------------------------------------

export default function UserTableRow({ row, selected, onEditRow, onSelectRow, setIsUpdate }) {
  const { classified_category_name } = row;
  ...
  const handleStatusChange = async (id) => {
    const res = await axios.delete(`https://dev-azproduction-api.flynautstaging.com/admin/deleteClassifiedCategory/${id}`, {
      headers: {
  ...
  return (
    <>
      <TableRow hover selected={selected}>
        ...
        <TableCell>
          <ListItemText
            primary={classified_category_name}
