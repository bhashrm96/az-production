...
import { _roles, _userList, MODERATOR_STATUS_OPTIONS } from 'src/_mock';
...
import UserTableRow from '../management-classified-table-row';
import UserTableToolbar from '../management-classified-table-toolbar';
import UserTableFiltersResult from '../management-classified-table-filters-result';
...
if ('moderator' in JSON.parse(localStorage.getItem("user"))) {
  ...
  if (filteredPermission[0].permission_name === "full access") {
    TABLE_HEAD = [
      { id: 'classified_category_name', label: 'Category' },
      { id: '' },
    ];
  } else {
    TABLE_HEAD = [
...
export default function UserListView() {
  ...
  useEffect(() => {
    axios.get("https://dev-azproduction-api.flynautstaging.com/admin/getAllClassifiedCategory").then((res) => {
            ...
            'moderator' in JSON.parse(localStorage.getItem("user"))
              ? (permissions.length > 0 &&
                ...
                ? <Button
                  ...
                  href={paths.dashboard.categoryManagement.newClassified}
                  variant="contained"
