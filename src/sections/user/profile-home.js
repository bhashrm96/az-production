  ...
  const renderAbout = (
    <Card>
      ...
      <Stack spacing={2} sx={{ p: 3 }}>
        <Box sx={{ typography: 'body2' }}>{info?.profile.bio}</Box>
      </Stack>

      <CardHeader title="Phone Number" />

      <Stack spacing={2} sx={{ p: 3 }}>
        <Box sx={{ typography: 'body2' }}>{info?.profile.phone_number}</Box>
      </Stack>

      <CardHeader title="Email" />

      <Stack spacing={2} sx={{ p: 3 }}>
        <Box sx={{ typography: 'body2' }}>{info?.profile.email_id}</Box>
      </Stack>
