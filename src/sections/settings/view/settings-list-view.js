...
import CommunityTableRow from '../settings-table-row';
import CommunityTableToolbar from '../settings-table-toolbar';
import CommunityTableFiltersResult from '../settings-table-filters-result';
...
export default function SettingsListView() {
  ...
  useEffect(() => {
    axios.get("https://dev-azproduction-api.flynautstaging.com/faq/get_faqs").then((res) => {
