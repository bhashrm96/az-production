...
export default function ProfileMembers({ followers, data }) {
...
function FollowerItem({ follower, selected, onSelected }) {
  const { first_name, last_name, avatarUrl, photo, photos } = follower;
  ...
  return (
    ...
    >
      <Avatar alt={first_name} src={photo ? photo[0]?.url : photos ? photos[0]?.url : null} sx={{ width: 48, height: 48, mr: 2 }} />
