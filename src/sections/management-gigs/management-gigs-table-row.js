...
import UserQuickEditForm from './management-gigs-quick-edit-form';

// ----------------------------------------------------------------------

export default function UserTableRow({ row, selected, onEditRow, onSelectRow, setIsUpdate }) {
  const { gigs_category_name } = row;
  ...
  const handleStatusChange = async (id) => {
    const res = await axios.delete(`https://dev-azproduction-api.flynautstaging.com/admin/deleteGigsCategory/${id}`, {
      headers: {
