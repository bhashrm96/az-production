...
import UserQuickEditForm from './management-events-quick-edit-form';

// ----------------------------------------------------------------------

export default function UserTableRow({ row, selected, onEditRow, onSelectRow, setIsUpdate }) {
  const { event_category_name } = row;
  ...
  const handleStatusChange = async (id) => {
    const res = await axios.delete(`https://dev-azproduction-api.flynautstaging.com/admin/deleteEventsCategory/${id}`, {
      headers: {
