...
import UserTableRow from '../management-events-table-row';
import UserTableToolbar from '../management-events-table-toolbar';
import UserTableFiltersResult from '../management-events-table-filters-result';
...
if ('moderator' in JSON.parse(localStorage.getItem("user"))) {
  ...
  if (filteredPermission[0].permission_name === "full access") {
    TABLE_HEAD = [
      { id: 'event_category_name', label: 'Category' },
      { id: '' },
    ];
  } else {
    TABLE_HEAD = [
...
export default function UserListView() {
  ...
  useEffect(() => {
    axios.get("https://dev-azproduction-api.flynautstaging.com/admin/getAllEventsCategory").then((res) => {
            ...
            'moderator' in JSON.parse(localStorage.getItem("user"))
              ? (permissions.length > 0 &&
                ...
                ? <Button
                  ...
                  href={paths.dashboard.categoryManagement.newEvents}
                  variant="contained"
