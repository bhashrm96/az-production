...
export default function CommunityQuickEditForm({ currentCommunity, open, onClose }) {
  ...
  const defaultValues = useMemo(
    () => ({
      firstname: currentCommunity?.firstname || '',
      email: currentCommunity?.email || '',
      phone: currentCommunity?.phone || '',
      lastname: currentCommunity?.lastname || '',
      company_address: currentCommunity?.company_address || '',
      dob: currentCommunity?.dob || '',
      city: currentCommunity?.city || '',
      state: currentCommunity?.state || '',
      zipcode: currentCommunity?.zipcode || '',
      company_name: currentCommunity?.company_name || '',
      website: currentCommunity?.website || '',
      company_about: currentCommunity?.company_about || '',
      position: currentCommunity?.position || '',
    }),
    [currentCommunity]
  );
...
CommunityQuickEditForm.propTypes = {
