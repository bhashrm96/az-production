...
import UserTableRow from '../management-community-table-row';
import UserTableToolbar from '../management-community-table-toolbar';
import UserTableFiltersResult from '../management-community-table-filters-result';
...
export default function UserListView() {
  ...
  useEffect(() => {
    axios.get("https://dev-azproduction-api.flynautstaging.com/admin/getAllCommunityCategory").then((res) => {
            ...
            'moderator' in JSON.parse(localStorage.getItem("user"))
              ? (permissions.length > 0 &&
                ...
                ? <Button
                  ...
                  href={paths.dashboard.categoryManagement.newCommunity}
                  variant="contained"
