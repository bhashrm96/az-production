...
import { useMockedModerator } from 'src/hooks/use-mocked-gigs';
...
export default function ProfilePostItem({ post }) {
  ...
  const renderHead = (
    <CardHeader
      disableTypography
      avatar={<Avatar src={gigs?.photoURL} alt={gigs?.displayName} />}
      title={
  ...
  const renderInput = (
    ...
    >
      <Avatar src={gigs?.photoURL} alt={gigs?.displayName} />
