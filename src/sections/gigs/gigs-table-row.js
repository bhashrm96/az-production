  ...
  return (
    <>
      <TableRow hover selected={selected}>
        ...
        <TableCell sx={{ whiteSpace: 'nowrap' }}>{gigs_title}</TableCell>

        <TableCell sx={{ whiteSpace: 'nowrap' }}>{gigs_category_name}</TableCell>
      ...
      <GigsQuickEditForm currentGigs={row} open={quickEdit.value} onClose={quickEdit.onFalse} />
