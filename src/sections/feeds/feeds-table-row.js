...
import FeedsQuickEditForm from './feeds-quick-edit-form';

// ----------------------------------------------------------------------

export default function FeedsTableRow({ row, selected, onEditRow, onSelectRow, }) {
  ...
  const handleStatusChange = async (id) => {
    const res = await axios.put(`https://dev-azproduction-api.flynautstaging.com/admin/feeds/update-status/${id}`, {
      headers: {
  ...
  return (
    <>
      ...
      <FeedsQuickEditForm currentFeeds={row} open={quickEdit.value} onClose={quickEdit.onFalse} />
