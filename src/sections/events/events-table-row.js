...
export default function EventsTableRow({ row, selected, onEditRow, onSelectRow, }) {
  ...
  const handleStatusChange = async (id) => {
    const res = await axios.put(`https://dev-azproduction-api.flynautstaging.com/admin/events/update-status/${id}`, {
      headers: {
  ...
  return (
    <>
      ...
      <EventsQuickEditForm currentEvents={row} open={quickEdit.value} onClose={quickEdit.onFalse} />
