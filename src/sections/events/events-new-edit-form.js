...
export default function EventsNewEditForm({ currentEvents }) {
  ...
  const onSubmit = handleSubmit(async (data) => {
    try {
      ...
      const response = await axios.post('https://dev-azproduction-api.flynautstaging.com/admin/create-events', body);
            ...
            <RHFSwitch
              ...
              label={
                <>
                  ...
                  <Typography variant="body2" sx={{ color: 'text.secondary' }}>
                    Disabling this will automatically send the events a verification email
                  </Typography>
                </>
              }
          ...
          <Card sx={{ p: 3 }}>
            ...
            <Stack alignItems="flex-end" sx={{ mt: 3 }}>
              <LoadingButton type="submit" variant="contained" loading={isSubmitting}>
                {!currentEvents ? 'Create Events' : 'Save Changes'}
              </LoadingButton>
            </Stack>
          </Card>
        </Grid>
