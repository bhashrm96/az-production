...
import UserTableRow from '../management-hashtags-table-row';
import UserTableToolbar from '../management-hashtags-table-toolbar';
import UserTableFiltersResult from '../management-hashtags-table-filters-result';
...
export default function UserListView() {
  ...
  useEffect(() => {
    axios.get("https://dev-azproduction-api.flynautstaging.com/admin/getAllHashtags").then((res) => {
            ...
            'moderator' in JSON.parse(localStorage.getItem("user"))
              ? (permissions.length > 0 &&
                ...
                ? <Button
                  ...
                  href={paths.dashboard.categoryManagement.newHashtags}
                  variant="contained"
