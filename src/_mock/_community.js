...
export const _communityFollowers = [...Array(18)].map((_, index) => ({
  id: _mock.id(index),
...
export const _communityFriends = [...Array(18)].map((_, index) => ({
  id: _mock.id(index),
...
export const _communityGallery = [...Array(12)].map((_, index) => ({
  id: _mock.id(index),
...
export const _communityFeeds = [...Array(3)].map((_, index) => ({
  id: _mock.id(index),
...
export const _communityCards = [...Array(21)].map((_, index) => ({
  id: _mock.id(index),
  role: _mock.role(index),
  name: _mock.fullName(index),
...
export const _communityPayment = [...Array(3)].map((_, index) => ({
  id: _mock.id(index),
...
export const _communityAddressBook = [...Array(4)].map((_, index) => ({
  id: _mock.id(index),
  primary: index === 0,
  name: _mock.fullName(index),
...
export const _communityInvoices = [...Array(10)].map((_, index) => ({
  id: _mock.id(index),
...
export const _communityList = [...Array(20)].map((_, index) => ({
  id: _mock.id(index),
  zipCode: '85807',
  state: 'Virginia',
  city: 'Rancho Cordova',
