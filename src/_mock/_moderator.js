...
export const _moderatorFollowers = [...Array(18)].map((_, index) => ({
  id: _mock.id(index),
...
export const _moderatorFriends = [...Array(18)].map((_, index) => ({
  id: _mock.id(index),
...
export const _moderatorGallery = [...Array(12)].map((_, index) => ({
  id: _mock.id(index),
...
export const _moderatorFeeds = [...Array(3)].map((_, index) => ({
  id: _mock.id(index),
...
export const _moderatorCards = [...Array(21)].map((_, index) => ({
  id: _mock.id(index),
  role: _mock.role(index),
  name: _mock.fullName(index),
...
export const _moderatorPayment = [...Array(3)].map((_, index) => ({
  id: _mock.id(index),
...
export const _moderatorAddressBook = [...Array(4)].map((_, index) => ({
  id: _mock.id(index),
  primary: index === 0,
  name: _mock.fullName(index),
...
export const _moderatorInvoices = [...Array(10)].map((_, index) => ({
  id: _mock.id(index),
...
export const _moderatorList = [...Array(20)].map((_, index) => ({
  id: _mock.id(index),
  zipCode: '85807',
  state: 'Virginia',
  city: 'Rancho Cordova',
