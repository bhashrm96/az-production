...
export const _vendorFollowers = [...Array(18)].map((_, index) => ({
  id: _mock.id(index),
...
export const _vendorFriends = [...Array(18)].map((_, index) => ({
  id: _mock.id(index),
...
export const _vendorGallery = [...Array(12)].map((_, index) => ({
  id: _mock.id(index),
...
export const _vendorFeeds = [...Array(3)].map((_, index) => ({
  id: _mock.id(index),
...
export const _vendorCards = [...Array(21)].map((_, index) => ({
  id: _mock.id(index),
  role: _mock.role(index),
  name: _mock.fullName(index),
...
export const _vendorPayment = [...Array(3)].map((_, index) => ({
  id: _mock.id(index),
...
export const _vendorAddressBook = [...Array(4)].map((_, index) => ({
  id: _mock.id(index),
  primary: index === 0,
  name: _mock.fullName(index),
...
export const _vendorInvoices = [...Array(10)].map((_, index) => ({
  id: _mock.id(index),
...
export const _vendorList = [...Array(20)].map((_, index) => ({
  id: _mock.id(index),
  zipCode: '85807',
  state: 'Virginia',
  city: 'Rancho Cordova',
