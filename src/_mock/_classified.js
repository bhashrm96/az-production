...
export const CLASSIFIED_STATUS_OPTIONS = [
...
export const _classifiedFollowers = [...Array(18)].map((_, index) => ({
  id: _mock.id(index),
...
export const _classifiedFriends = [...Array(18)].map((_, index) => ({
  id: _mock.id(index),
...
export const _classifiedGallery = [...Array(12)].map((_, index) => ({
  id: _mock.id(index),
...
export const _classifiedFeeds = [...Array(3)].map((_, index) => ({
  id: _mock.id(index),
...
export const _classifiedCards = [...Array(21)].map((_, index) => ({
  id: _mock.id(index),
  role: _mock.role(index),
  name: _mock.fullName(index),
...
export const _classifiedPayment = [...Array(3)].map((_, index) => ({
  id: _mock.id(index),
...
export const _classifiedAddressBook = [...Array(4)].map((_, index) => ({
  id: _mock.id(index),
  primary: index === 0,
  name: _mock.fullName(index),
...
export const _classifiedInvoices = [...Array(10)].map((_, index) => ({
  id: _mock.id(index),
...
export const _classifiedList = [...Array(20)].map((_, index) => ({
  id: _mock.id(index),
  zipCode: '85807',
  state: 'Virginia',
  city: 'Rancho Cordova',
