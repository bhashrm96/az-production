...
export const FEEDS_STATUS_OPTIONS = [
...
export const _feedsFollowers = [...Array(18)].map((_, index) => ({
  id: _mock.id(index),
...
export const _feedsFriends = [...Array(18)].map((_, index) => ({
  id: _mock.id(index),
...
export const _feedsGallery = [...Array(12)].map((_, index) => ({
  id: _mock.id(index),
...
export const _feedsFeeds = [...Array(3)].map((_, index) => ({
  id: _mock.id(index),
...
export const _feedsCards = [...Array(21)].map((_, index) => ({
  id: _mock.id(index),
  role: _mock.role(index),
  name: _mock.fullName(index),
...
export const _feedsPayment = [...Array(3)].map((_, index) => ({
  id: _mock.id(index),
...
export const _feedsAddressBook = [...Array(4)].map((_, index) => ({
  id: _mock.id(index),
  primary: index === 0,
  name: _mock.fullName(index),
...
export const _feedsInvoices = [...Array(10)].map((_, index) => ({
  id: _mock.id(index),
...
export const _feedsList = [...Array(20)].map((_, index) => ({
  id: _mock.id(index),
  zipCode: '85807',
  state: 'Virginia',
  city: 'Rancho Cordova',
