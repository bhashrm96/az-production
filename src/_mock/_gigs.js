...
export const _gigsFollowers = [...Array(18)].map((_, index) => ({
  id: _mock.id(index),
...
export const _gigsFriends = [...Array(18)].map((_, index) => ({
  id: _mock.id(index),
...
export const _gigsGallery = [...Array(12)].map((_, index) => ({
  id: _mock.id(index),
...
export const _gigsFeeds = [...Array(3)].map((_, index) => ({
  id: _mock.id(index),
...
export const _gigsCards = [...Array(21)].map((_, index) => ({
  id: _mock.id(index),
  role: _mock.role(index),
  name: _mock.fullName(index),
...
export const _gigsPayment = [...Array(3)].map((_, index) => ({
  id: _mock.id(index),
...
export const _gigsAddressBook = [...Array(4)].map((_, index) => ({
  id: _mock.id(index),
  primary: index === 0,
  name: _mock.fullName(index),
...
export const _gigsInvoices = [...Array(10)].map((_, index) => ({
  id: _mock.id(index),
...
export const _gigsList = [...Array(20)].map((_, index) => ({
  id: _mock.id(index),
  zipCode: '85807',
  state: 'Virginia',
  city: 'Rancho Cordova',
