...
export const _eventsFollowers = [...Array(18)].map((_, index) => ({
  id: _mock.id(index),
...
export const _eventsFriends = [...Array(18)].map((_, index) => ({
  id: _mock.id(index),
...
export const _eventsGallery = [...Array(12)].map((_, index) => ({
  id: _mock.id(index),
...
export const _eventsFeeds = [...Array(3)].map((_, index) => ({
  id: _mock.id(index),
...
export const _eventsCards = [...Array(21)].map((_, index) => ({
  id: _mock.id(index),
  role: _mock.role(index),
  name: _mock.fullName(index),
...
export const _eventsPayment = [...Array(3)].map((_, index) => ({
  id: _mock.id(index),
...
export const _eventsAddressBook = [...Array(4)].map((_, index) => ({
  id: _mock.id(index),
  primary: index === 0,
  name: _mock.fullName(index),
...
export const _eventsInvoices = [...Array(10)].map((_, index) => ({
  id: _mock.id(index),
...
export const _eventsList = [...Array(20)].map((_, index) => ({
  id: _mock.id(index),
  zipCode: '85807',
  state: 'Virginia',
  city: 'Rancho Cordova',
